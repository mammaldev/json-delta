    ...
    if (
      ...
      [ tVars, yVars ].forEach(function( diffVars, i ) {
        ...
        while (
          ...
          var isAddIdChange =
            descendentChange.changeType === CHANGE_TYPES.ADD_PROPERTY &&
            typeof descendentChange.path[ descendentChange.path.length - 2 ] === 'number' &&
            !!~this.idKeys.indexOf(descendentChange.path[ descendentChange.path.length - 1 ]);
